...
/// Application-scoped offline services. Inject the real authenticated backend
/// adapter from the host app; this module never stores credentials or URLs.
class TerraGuardOfflineServices {
  ...
  factory TerraGuardOfflineServices({required TerraGuardSyncApi api}) {
    ...
    return TerraGuardOfflineServices._(
      store,
      OfflineSyncManager(store: store, api: api),
    );
  }
