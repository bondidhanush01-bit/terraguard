...
/// Backend boundary for the existing TerraGuard API.
/// Replace the implementation with the authenticated API client without changing the queue.
...
class OfflineSyncManager {
  ...
  Future<void> stop() => _connectivitySubscription?.cancel() ?? Future.value();
